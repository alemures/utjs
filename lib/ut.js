...
(function() {
  ...
  function dateToString(date) {
    return paddingLeft(date.getDate(), '0', 2) + ' ' + months[date.getMonth()] + ' ' +
        date.getFullYear() + ' ' + paddingLeft(date.getHours(), '0', 2) + ':' +
        paddingLeft(date.getMinutes(), '0', 2) + ':' + paddingLeft(date.getSeconds(), '0', 2);
  }
