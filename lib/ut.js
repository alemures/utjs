...
(function () {
    ...
    var logger = {
        ...
        debug: function(data) {
            console.log(this._createHeader(' [DEBUG] ') + JSON.stringify(data));
        },
        info: function(data) {
            console.log(this._createHeader(' [INFO] ') + JSON.stringify(data));
        },
        warn: function(data) {
            console.log(this._createHeader(' [WARN] ') + JSON.stringify(data));
        },
        error: function(data) {
            console.log(this._createHeader(' [ERROR] ') + JSON.stringify(data));
        },
        ...
        _getDate: function() {
            var d = new Date();
            return d.getDate() + ' ' + this._months[d.getMonth()] + ' ' + d.getFullYear() + ' '
