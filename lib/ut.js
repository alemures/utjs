...
(function () {
    ...
    function dateToString(date) {
        return padding(date.getDate(), '0', 2) + ' ' + months[date.getMonth()] + ' ' + date.getFullYear() + ' '
            + padding(date.getHours(), '0', 2) + ':' + padding(date.getMinutes(), '0', 2) + ':' + padding(date.getSeconds(), '0', 2);
    }
    ...
    function padding(string, pad, finalLength) {
        var n = Math.ceil(logN(2, finalLength));
        var i;
        ...
        var padded =  pad + string;
        return padded.substring(padded.length - finalLength);
    }
